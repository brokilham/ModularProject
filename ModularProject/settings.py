"""
Django settings for ModularProject project.
...
SECRET_KEY = '64)!()+wucr=ltu+1-hb7r+o(r@ghxo^psmh!*4)8^04%q5+88'
...
ROOT_URLCONF = 'ModularProject.urls'
...
WSGI_APPLICATION = 'ModularProject.wsgi.application'
